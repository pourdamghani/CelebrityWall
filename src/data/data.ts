...
export const data: { celebrities: Celebrity[] } = {
  celebrities: [
    ...
    },
    {
      ...
      category: 'SINGER',
      status: 'GOOD',
      statusReferenceUrl: 'https://news.yahoo.com/kim-kardashian-justin-bieber-more-181532016.html?guccounter=1',
    },
    {
      id: 'taylorswift13',
      name: 'Taylor Swift',
    ...
    },
    {
      ...
      category: 'HOST',
      status: 'GOOD',
      statusReferenceUrl: 'https://www.instagram.com/p/CjJDjqQpG9L/?hl=en',
    },
    {
      id: 'britneyspears',
      name: 'Britney Spears 🌹🚀',
